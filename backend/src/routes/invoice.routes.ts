...
const router = Router();
router.get('/',               authenticate, authorize('ADMIN','PROCUREMENT_OFFICER','MANAGER','VENDOR'), ctrl.listInvoices);
router.post('/',              authenticate, authorize('ADMIN','PROCUREMENT_OFFICER','VENDOR'),           ctrl.generateInvoice);
